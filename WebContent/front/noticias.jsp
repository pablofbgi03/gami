            ...
            <body>
                    ...
                    <div class="container">
                        ...
                        <div class="collapse navbar-collapse" id="navbarResponsive">
                            <ul class="navbar-nav ml-auto">
                                ...
                                <li class="nav-item">
                                    <a class="nav-link" href="mostrarNoticiasIndex.do">Noticias</a>
                                </li>
                                <li class="nav-item">
                ...
                <div class="container">
                    ...
                    <c:forEach items="${listaNoticias}" var="noticia">
                        <div class="row mb-5">
                            <div class="col-md-7">
                                <a href="MostrarNoticia.do?id=${noticia.idnoticia}">
                                 <img class="img-fluid rounded mb-3 mb-md-0" src="http://placehold.it/700x300" alt="">
				            </a>
                            </div>
                            <div class="col-md-5">
                                <h4>${noticia.nombre}</h4>
                                <p>
                                    
                                    <br><b>Fecha:</b> ${noticia.fechaalta}
                                    <br>${noticia.texto}
