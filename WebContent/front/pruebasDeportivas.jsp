...
<body>
	...
	<div class="container">
		...
		<h1 class="mt-4 mb-3">Pruebas Deportivas</h1>

		<!-- Intro Content -->
		<div class="row">
			<c:forEach items="${listaPruebasDeportivas}" var="prueba">
				<div class="col-lg-6">
					<h4>${prueba.nombre}</h4>
					<a href="MostrarPruebaDeportivaUnica.do?id=${prueba.idpruebadeportiva}">Participar
						en la prueba</a><br>
				</div>
		</c:forEach>
		</div>
