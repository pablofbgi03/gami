        ...
        <%@ taglib uri="http://java.sun.com/jsp/jstl/fmt" prefix="fmt"%>
            ...
            <body>
                ...
                <div class="container">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            ...
                            <ul>
                                ...
                                <li>
                                	<a href="MostrarParadasFront.do?id=${itinerario.iditinerario}">Ver las paradas del itinerario</a>
                                </li>
                            </ul>
                        </div>
                    ...
                    <h3 class="my-4">Paradas</h3>

                    <div class="row">
                        <!-- Paradas relacionadas al itinerario -->
                         <c:forEach items="${listaParadas}" var="parada">
                            <div class="col-md-3 col-sm-6 mb-4">
                                <a href="MostrarParada.do?id=${parada.idparada}">
