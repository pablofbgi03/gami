...
<body>
	...
	<div class="row">
		<form action="InsertarComentarioFront.do?idmultimedia=${idmultimedia}" method="POST" enctype="multipart/form-data">
			<input type="hidden" name="idmultimedia" value="<%=request.getParameter("idmultimedia")%>">
				Comentario<input type="textarea" name="comentario" /></br>
