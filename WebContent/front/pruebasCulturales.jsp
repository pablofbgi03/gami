...
<body>
	...
	<div class="container">
		...
		<h1 class="mt-4 mb-3">Pruebas Culturales</h1>

		<!-- Intro Content -->
		<div class="row">
			<c:forEach items="${listaPruebasCulturales}" var="prueba">
				<div class="col-lg-6">
					<h4>${prueba.nombre}</h4>
					<a href="MostrarPruebaCulturalUnica.do?id=${prueba.idpruebacultural}">Participar
						en la prueba</a><br>
				</div>
		</div>
		</c:forEach>
