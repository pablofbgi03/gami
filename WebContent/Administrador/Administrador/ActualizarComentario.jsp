                        ...
                        <div class="row">
                            <div class="col-md-12 col-sm-12 col-xs-12">
                                <div class="x_panel">
                                    ...
                                    <div class="x_content">
                                        <form action="../../actualizarComentario.do">
                                            <table>
                                                <tr>
                                                    <th>Id Comentario</th>
                                                    <th>Cliente</th>
                                                ...
                                                <tr>
                                                    <td><input name="idcomentario" type="text" value="<%=request.getParameter("idcomentario")%>"></td>
                                                    <td><input name="cliente" type="text" value="<%=request.getParameter("cliente")%>"></td>
                                                    <td><input name="multimedia" type="text" value="<%=request.getParameter("multimedia")%>"></td>
                                                    <td><input name="texto" type="textarea" value="<%=request.getParameter("texto")%>"></td>
                                        ...
                                        <form action="../../mostrarComentario.do">
