            ...
            <div class="row">
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  ...
                  <div class="x_content">
                      <form action="../../modificarNoticia.do">
                        <table>
                        <tr><th>Id Noticia</th><th>Nombre</th><th>Texto</th><th>Fecha de Alta</th><th>Fecha de Caducidad</th>
                        <th>Imagen</th></tr>
                        <tr><td><input name="idnoticia" type="text" value="<%=request.getParameter("idnoticia")%>"></td>
                        <td><input name="nombre" type="text" value="<%=request.getParameter("nombre")%>"></td>
                        <td><input name="texto" type="text" value="<%=request.getParameter("texto")%>"></td>
                        <td><input name="fechaalta" type="text" value="<%=request.getParameter("fechaalta")%>"></td>
                        <td><input name="fechacaducidad" type="text" value="<%=request.getParameter("fechacaducidad")%>"></td>
                        ...
                        <form action="../../mostrarNoticias.do">
