...
pageEncoding="UTF-8"%>
    ...
    <head>
        ...
        <script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyBXd8kaGh6JcMudnMl7Q4yQQceYyUPRegw"></script>
        <script language="JavaScript" SRC="../src/js/mapa.js"></script>
                        ...
                        <div class="row">
                            <div class="col-md-12 col-sm-12 col-xs-12">
                                <div class="x_panel">
                                    ...
                                    <div class="x_content">
                                        <form action="../../insertarParada.do" method="get">
                                            ...
                                            Historia <input type="textarea" name="historia"><br/> 
                                            Anecdotario <input type="textarea" name="anecdotario"><br/> 
                                            Gastronomia <input type="textarea" name="gastronomia"><br/> 
