                            ...
                            <div class="row">
                                <div class="col-md-12 col-sm-12 col-xs-12">
                                    <div class="x_panel">
                                        ...
                                        <div class="x_content">
                                                                                            <a href="PreInsertarComentario.do">Insertar comentario</a>
                                            ...
                                            <table id="datatable" class="table table-striped table-bordered">
                                                ...
                                                <c:forEach items="${listaComentarios}" var="unComentario">
                                                    <tr>
                                                        <td>${unComentario.cliente.nombre}</td>
                                                        <td>${unComentario.multimedia.idmultimedia}</td>
                                                        <td>${unComentario.texto}</td>

                                                        <td><a href="borrarComentario.do?idcomentario=${unComentario.idcomentario}">Borrar
															Comentario</a></td>

                                                        <td><a href="Administrador/Administrador/ActualizarComentario.jsp?idcomentario=${unComentario.idcomentario}&cliente=${unComentario.cliente.idcliente}&multimedia=${unComentario.multimedia.idmultimedia}
															&texto=${unComentario.texto}">Actualizar comentario</a></td>
                                                    </tr>
                                                </c:forEach>
                                            </table>
                                        </div>
