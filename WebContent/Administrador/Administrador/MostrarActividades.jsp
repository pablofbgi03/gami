                                        ...
                                        <div class="x_panel">
                                            ...
                                            <div class="x_content">
                                                <table id="datatable" class="table table-striped table-bordered">
                                                    <tr>
                                                        <a href="Administrador/Administrador/InsertarActividad.jsp">Insertar actividad</a>
                                                    </tr>
                                                    <tr>
                                                        <th>Id</th>
                                                        <th>Nombre</th>
                                                        ...
                                                        <th>Fecha Fin</th>
                                                        <th>UbicaciÃ³n</th>
                                                        <th>NÃºm. Participantes</th>
                                                        <th>Precio</th>
                                                        <th>Imagen</th>
                                                        <th>Puntos</th>
                                                    </tr>
                                                    <c:if test="${not empty listaActividades}">
                                                        <c:forEach items="${listaActividades}" var="unActividad">
                                                            <tr>
                                                                <td>
                                                                    <c:out value="${unActividad.idactividad}" />
                                                                </td>
                                                                <td>
                                                                    <c:out value="${unActividad.nombre}" />
                                                                </td>
                                                                <td>
                                                                    <c:out value="${unActividad.fechainicio}" />
                                                                </td>
                                                                <td>
                                                                    <c:out value="${unActividad.fechafin}" />
                                                                </td>
                                                                <td>
                                                                    <c:out value="${unActividad.ubicacion}" />
                                                                </td>
                                                                <td>
                                                                    <c:out value="${unActividad.numparticipantes}" />
                                                                </td>
                                                                <td>
                                                                    <c:out value="${unActividad.precio}" />
                                                                </td>
                                                                <td>
                                                                    <c:out value="${unActividad.imagen}" />
                                                                </td>
                                                                <td>
                                                                    <c:out value="${unActividad.puntos}" />
                                                                </td>
                                                                <td><a href="borrarActividad.do?idActividad=${unActividad.idactividad}">Borrar actividad</a>
                                                                </td>
                                                                <td><a href="Administrador/Administrador/ActualizarActividadFormulario.jsp?idActividad=${unActividad.idactividad}&nombre=${unActividad.nombre}
																		&fechaInicio=${unActividad.fechainicio}&fechaFin=${unActividad.fechafin}
																		&ubicacion=${unActividad.ubicacion}&numParticipantes=${unActividad.numparticipantes}
																		&precio=${unActividad.precio}&imagen=${unActividad.imagen}
																		&puntos=${unActividad.puntos}">Actualizar actividad</a>
																</td>
                                                            </tr>
                                                        </c:forEach>
                                                    </c:if>
                                                    <c:if test="${empty listaActividades}">
                                                        <center>
                                                            <p>No hay actividades actualmente</p>
                                                        </center>
                                                    </c:if>
                                                </table>
                                            </div>
