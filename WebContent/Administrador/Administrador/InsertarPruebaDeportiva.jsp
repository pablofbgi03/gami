                            ...
                            <div class="col-md-12 col-sm-12 col-xs-12">
                                <div class="x_panel">
                                    ...
                                    <div class="x_content">
                                        ...
                                        <form action="../../insertarPruebaDeportiva.do" method="POST">
											...
											Fecha fin (aaaa-mm-dd) <input type="text" name="fechaFin"><br/>
											Explicacion <input type="textarea" name="explicacion"><br/>
