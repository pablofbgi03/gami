                        ...
                        <div class="row">
                            <div class="col-md-12 col-sm-12 col-xs-12">
                                <div class="x_panel">
                                    ...
                                    <div class="x_content">
                                        <form action="../../actualizarActividad.do" method="get">
                                            <input type="hidden" name="idActividad" value="<%=request.getParameter("idActividad")%>"> Nombre
                                            <input type="text" name="nombre" value="<%=request.getParameter("nombre")%>"/><br>
                                            Fecha inicio<input type="text" name="fechaInicio" value="<%=request.getParameter("fechaInicio")%>"><br>
                                            Fecha fin<input type="text" name="fechaFin" value="<%=request.getParameter("fechaFin")%>"/><br>
                                            Ubicacion<input type="text" name="ubicacion" value="<%=request.getParameter("ubicacion")%>"/><br>
                                            Num. Participantes<input type="text" name="numParticipantes" value="<%=request.getParameter("numParticipantes")%>"/><br>
                                            ...
                                            Puntos<input type="text" name="puntos" value="<%=request.getParameter("puntos")%>"/><br>
                                            <input type="submit" value="Enviar" />
                                        </form>
                                        <form action="../../mostrarActividad.do">
