                            ...
                            <div class="col-md-12 col-sm-12 col-xs-12">
                                <div class="x_panel">
                                    ...
                                    <div class="x_content">
                                        ...
                                        <form action="../../insertarCliente.do" method="get">

                                            Nombre<input type="text" name="nombre" /><br> Apellidos
                                            <input type="text" name="apellidos" /><br> Fecha de Nacimiento(aaaa-mm-dd)<input type="text" name="fechanacimiento" /><br> Email
                                            <input type="email" name="email" /><br> Rol <select name="rol_idrol">
                            					<option value="1">Administrador</option>
                            					<option value="2">Registrado</option>
                          					</select><br> Password
                                            <input type="password" name="password" /><br> Telefono
                                            <input type="text" name="telefono" /> <br> Dirección
                                            <input type="text" name="direccion" /><br> Codigo Postal<input type="text" name="codigopostal" /><br> Avatar
                                            <input type="text" name="avatar" /><br> Puntos acumulados<input type="text" name="puntosacumulados" /><br>
