                                ...
                                <div class="x_panel">
                                    ...
                                    <div class="x_content">
                                        ...
                                        <form action="../../insertarNoticia.do" method="get">
                                            ...
                                            Texto<input type="textarea" name="texto" /></br>
                                            Fecha de alta(aaaa-mm-dd)<input type="text" name="fechaalta" /></br>
                                            Fecha de caducidad(aaaa-mm-dd)<input type="text" name="fechacaducidad" /></br>
