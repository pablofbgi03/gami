                                ...
                                <div class="col-md-12 col-sm-12 col-xs-12">
                                    <div class="x_panel">
                                        ...
                                        <div class="x_content">
                                            ...
                                            <tr>
                                                <a href="Administrador/Administrador/InsertarPruebaDeportiva.jsp?id=<%=request.getAttribute("idParada")%>">Insertar prueba deportiva</a>
                                            </tr>
                                                <tr>
                                                    <th>Nombre</th>
                                                    <th>Fecha Inicio</th>
                                                ...
                                                <c:forEach items="${listaPruebasDeportivas}" var="pruebaDeportiva">
                                                    <tr>
                                                        <td>${pruebaDeportiva.nombre}</td>
                                                        <td>${pruebaDeportiva.fechainicio}</td>
                                                        <td>${pruebaDeportiva.fechafin}</td>
                                                        <td>${pruebaDeportiva.explicacion}</td>
                                                        <td>${pruebaDeportiva.puntos}</td>
                                                        <td><a href="borrarPruebaDeportiva.do?id=${pruebaDeportiva.idpruebadeportiva}">Borrar prueba deportiva</a></td>
                                                        <td><a href="Administrador/Administrador/ActualizarPruebaDeportiva.jsp?id=${pruebaDeportiva.idpruebadeportiva}&nombre=${pruebaDeportiva.nombre}&fechainicio=${pruebaDeportiva.fechainicio}&fechafin=${pruebaDeportiva.fechafin}&explicacion=${pruebaDeportiva.explicacion}&puntos=${pruebaDeportiva.puntos}">Actualizar prueba deportiva</a></td>
                                                        <td><a href="mostrarMultimedia.do?id=${pruebaDeportiva.idpruebadeportiva}">Mostrar
																Multimedias</a>
                                                    </tr>
                                                </c:forEach>
                                            </table>
