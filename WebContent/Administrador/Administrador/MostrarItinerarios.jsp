              ...
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    ...
                    <tr>
                        <a href="Administrador/Administrador/InsertarItinerario.jsp">Insertar itinerario</a>
                    </tr>
                        <tr>
							<th>Nombre</th>
							<th>Categoria</th>
							...
							<c:forEach items="${listaItinerarios}" var="itinerario">
								<tr>
                 					...
                 					<td>${itinerario.categoria}</td>
                  					...
                  					<td><a href="borrarItinerario.do?id=${itinerario.iditinerario}">Borrar itinerario</a></td>
                  					<td><a href="Administrador/Administrador/ActualizarItinerario.jsp?id=${itinerario.iditinerario}&categoria=${itinerario.categoria}&nombre=${itinerario.nombre}&duracion=${itinerario.duracion}&ubicacion=${itinerario.ubicacion}">Actualizar
                      Itinerario</a></td>
                  <td><a href="mostrarParada.do?id=${itinerario.iditinerario}">Mostrar
                      Paradas</a></td>
                </tr>
							</c:forEach>
						</tr>
