                                ...
                                <div class="col-md-12 col-sm-12 col-xs-12">
                                    <div class="x_panel">
                                        ...
                                        <div class="x_content">
                                            ...
                                            <tr>
                                                <a href="Administrador/Administrador/InsertarParada.jsp?id=<%=request.getAttribute("idItinerario")%>">Insertar parada</a>
                                            </tr>
                                                <tr>
                                                    <th>Nombre</th>
                                                    <th>Numero</th>
                                                ...
                                                <c:forEach items="${listaParadas}" var="parada">
                                                    <tr>
                                                        ...
                                                        <td>${parada.imagen}</td>
                                                        <td><a href="borrarParada.do?id=${parada.idparada}">Borrar parada</a></td>
                                                        <td><a
																href="Administrador/Administrador/ActualizarParada.jsp?id=${parada.idparada}&nombre=${parada.nombre}&numeroParada=${parada.numeroParada}&ubicacion=${parada.ubicacion}&historia=${parada.historia}&anecdotario=${parada.anecdotario}&gastronomia=${parada.gastronomia}&imagen=${parada.imagen}">Actualizar
																parada</a>
																<td><a href="mostrarPruebaCultural.do?idParada=${parada.idparada}">Mostrar
																pruebas culturales</a>
																<td><a href="mostrarPruebaDeportiva.do?id=${parada.idparada}">Mostrar
																pruebas deportivas</a>
