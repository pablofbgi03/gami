                            ...
                            <div class="col-md-12 col-sm-12 col-xs-12">
                                <div class="x_panel">
                                    ...
                                    <div class="x_content">
                                        ...
                                        <form action="../../insertarMultimedia.do" method="POST" enctype="multipart/form-data">
											<input type="hidden" name="id" value="<%=request.getParameter("id") %>">
                                            E-mail<input type="text" name="email" /></br>
                                            Fecha inicio (aaaa-mm-dd) <input type="text" name="fecha"><br/>
                                            Comentario<input type="text" name="comentario" /></br>
                                            Imagen<input type="file" size="30" value="" name="archivo" /></br>
											<!-- Video<input type="file" size="30" value="" name="video" /></br>-->
