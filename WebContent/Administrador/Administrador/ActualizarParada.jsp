                        ...
                        <div class="row">
                            <div class="col-md-12 col-sm-12 col-xs-12">
                                <div class="x_panel">
                                    ...
                                    <div class="x_content">
                                        <form action="../../actualizarParada.do" method="get">
                                            ...
                                            Numero <input type="text" name="numero" value="<%=request.getParameter("numeroParada") %>"><br/> 
                                            Ubicacion <input type="text" name="ubicacion" value="<%=request.getParameter("ubicacion") %>"><br/> 
                                            Historia <input type="textarea" name="historia" value="<%=request.getParameter("historia") %>"><br/> 
                                            Anecdotario <input type="textarea" name="anecdotario" value="<%=request.getParameter("anecdotario") %>"><br/> 
                                            Gastronomia <input type="textarea" name="gastronomia" value="<%=request.getParameter("gastronomia") %>"><br/> 
