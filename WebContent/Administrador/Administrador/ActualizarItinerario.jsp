                        ...
                        <div class="row">
                            <div class="col-md-12 col-sm-12 col-xs-12">
                                <div class="x_panel">
                                    ...
                                    <div class="x_content">
                                        <form action="../../actualizarItinerario.do" method="get">
                                            Id<input type="hidden" name="id" value="<%=request.getParameter("id") %>"> Nombre
                                            <input type="text" name="nombre" value="<%=request.getParameter("nombre") %>"/></br>
                                            Categoria<input type="text" name="categoria" value="<%=request.getParameter("categoria") %>"/></br>
                                            Duracion<input type="text" name="duracion" value="<%=request.getParameter("duracion") %>"/></br>
                                            Ubicacion<input type="text" name="ubicacion" value="<%=request.getParameter("ubicacion") %>" /></br>

                                            <input type="submit" value="Enviar" />
                                        </form>
                                        <a href="../../mostrarItinerario.do">Volver</a><br>
                                    </div>
                                </div>
                            </div>
                        </div>
