                            ...
                            <div class="col-md-12 col-sm-12 col-xs-12">
                                <div class="x_panel">
                                    ...
                                    <div class="x_content">
                                        ...
                                        <form action="../../actualizarPruebaDeportiva.do" method="GET">
                                            ...
                                            Fecha inicio (aaaa-mm-dd) <input type="text" name="fechaInicio" value="<%=request.getParameter("fechainicio") %>"><br/> 
                                            Fecha fin (aaaa-mm-dd) <input type="text" name="fechaFin" value="<%=request.getParameter("fechafin") %>"><br/> 
                                            Explicacion <input type="textarea" name="explicacion" value="<%=request.getParameter("explicacion") %>"><br/> 
