                                    ...
                                    <div class="x_panel">
                                        ...
                                        <div class="x_content">
                                            <table id="datatable" class="table table-striped table-bordered">
                                                <tr>
                                                    <a href="Administrador/Administrador/InsertarVoto.jsp">Insertar voto</a>
                                                </tr>
                                                <tr>
                                                    <th>Id</th>
                                                    <th>Cliente</th>
                                                ...
                                                <c:forEach items="${listaVotos}" var="unVoto">
                                                    <tr>
                                                        <td>${unVoto.idvoto}</td>
                                                        <td>${unVoto.cliente.idcliente}</td>
                                                        <td>${unVoto.multimedia.idmultimedia}</td>
                                                        <td>${unVoto.puntos}</td>
                                                        ...
                                                        <td><a href="borrarVoto.do?idVoto=${unVoto.idvoto}" />Borrar voto</a>
                                                        </td>
                                                        <td><a href="Administrador/Administrador/ActualizarVoto.jsp?idVoto=${unVoto.idvoto}&cliente=${unVoto.cliente.idcliente}
																	&multimedia=${unVoto.multimedia.idmultimedia}&puntos=${unVoto.puntos}" />Actualizar voto</a>
														</td>
                                                  	</tr>
                                                 </c:forEach>
                                            </table>
