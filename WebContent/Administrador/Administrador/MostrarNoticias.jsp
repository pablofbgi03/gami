                                        ...
                                        <div class="x_panel">
                                            ...
                                            <div class="x_content">
                                                <table id="datatable" class="table table-striped table-bordered">
                                                    <thead>
                                                    <tr>
                                                        <a href="Administrador/Administrador/InsertarNoticias.jsp">Insertar noticia</a>
                                                    </tr>
                                                        <tr>
                                                            <th>Id de noticias</th>
                                                            <th>Nombre</th>
                                                            <th>Texto</th>
                                                            <th>Fecha alta</th>
                                                    ...
                                                    <tbody>
                                                        <c:forEach items="${listaNoticias}" var="noticia">
                                                            <tr>
                                                                <td>
                                                                    <c:out value="${noticia.idnoticia}" />
                                                                </td>
                                                                <td>
                                                                    <c:out value="${noticia.nombre}" />
                                                                </td>
                                                                <td>
                                                                    <c:out value="${noticia.texto}" />
                                                                </td>
                                                                <td>
                                                                    <c:out value="${noticia.fechaalta}" />
                                                                </td>
                                                                <td>
                                                                    <c:out value="${noticia.fechacaducidad}" />
                                                                </td>
                                                                <td>
                                                                    <c:out value="${noticia.imagen}" />
                                                                </td>
                                                                <td><a href="Administrador/Administrador/ActualizarNoticia.jsp?idnoticia=${noticia.idnoticia}&nombre=${noticia.nombre}&texto=${noticia.texto}
											&fechaalta=${noticia.fechaalta}&fechacaducidad=${noticia.fechacaducidad}&imagen=${noticia.imagen}">Modificar</a></td>
                                                                <td><a href="borrarNoticia.do?idnoticia=${noticia.idnoticia}">Eliminar</a></td>
                                                            </tr>
                                                        </c:forEach>
                                                    </tbody>
                                                </table>
