                            ...
                            <div class="col-md-12 col-sm-12 col-xs-12">
                                <div class="x_panel">
                                    ...
                                    <div class="x_content">
                                        ...
                                        <c:if test="${not empty listaMultimedia && not empty listaClientes}">

                                            <form action="insertarComentario.do" method="get">

                                                Cliente<select name="cliente">
                                  <c:forEach items="${listaClientes}" var="unCliente">
                                  <option value="${unCliente.idcliente}">${unCliente.nombre}</option>
                                  </c:forEach>
                                          </select></br>
                                                Multimedia<select name="multimedia">
                                  <c:forEach items="${listaMultimedia}" var="unMultimedia">
                                  <option value="${unMultimedia.idmultimedia}">${unMultimedia.idmultimedia}</option>
                                  </c:forEach>
                                          </select></br>
                                                Texto<input type="textarea" name="texto" required/></br>
                                        ...
                                        <c:if test="${empty listaMultimedia || empty listaClientes}">
                                            <h3>No hay Archivos multimedia o clientes</h3>
                                        </c:if>
                                        <a href="mostrarComentario.do">Volver a comentarios</a>
