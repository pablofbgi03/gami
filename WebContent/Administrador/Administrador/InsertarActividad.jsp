                            ...
                            <div class="col-md-12 col-sm-12 col-xs-12">
                                <div class="x_panel">
                                    ...
                                    <div class="x_content">
                                        ...
                                        <form action="../../insertarActividad.do" method="get">

                                            Nombre<input type="text" name="nombre" /></br>
                                            Fecha inicio<input type="text" name="fechaInicio" /></br>
                                            Fecha fin<input type="text" name="fechaFin" /></br>
                                            Ubicacion<input type="text" name="ubicacion" /></br>
                                            Num. Participantes<input type="text" name="numParticipantes" value="0" /> </br>
                                            Precio<input type="text" name="precio" value="0" /></br>
                                            Imagen<input type="text" name="imagen" /></br>
                                            Puntos<input type="text" name="puntos" value="0" /></br>
