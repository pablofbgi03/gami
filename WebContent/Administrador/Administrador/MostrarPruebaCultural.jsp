                                ...
                                <div class="col-md-12 col-sm-12 col-xs-12">
                                    <div class="x_panel">
                                        ...
                                        <div class="x_content">
                                            ...
                                            <tr>
                                                <a href="Administrador/Administrador/InsertarPruebaCultural.jsp?id=<%=request.getAttribute("idParada")%>">Insertar prueba cultural</a>
                                            </tr>
                                                <th>Nombre</th>
                                                <th>Pregunta</th>
                                                <th>Respuesta</th>
                                                ...
                                                <c:forEach items="${listaPruebasCulturales}" var="pruebaCultural">
                                                    <tr>
                                                        <td>${pruebaCultural.nombre}</td>
                                                        <td>${pruebaCultural.pregunta}</td>
                                                        <td>${pruebaCultural.respuesta}</td>
                                                        <td>${pruebaCultural.puntos}</td>
                                                        <td><a href="borrarPruebaCultural.do?id=${pruebaCultural.idpruebacultural}&idParada=${idParada}">Borrar prueba cultural</a></td>
                                                        <td><a href="Administrador/Administrador/ActualizarPruebaCultural.jsp?id=${pruebaCultural.idpruebacultural}&nombre=${pruebaCultural.nombre}&pregunta=${pruebaCultural.pregunta}&respuesta=${pruebaCultural.respuesta}&puntos=${pruebaCultural.puntos}&idParada=${idParada}">Actualizar prueba cultural</a></td>
                                                    </tr>
                                                </c:forEach>
                                            </table>
                                        </div>
