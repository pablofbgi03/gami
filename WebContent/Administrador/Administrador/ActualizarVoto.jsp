                            ...
                            <div class="col-md-12 col-sm-12 col-xs-12">
                                <div class="x_panel">
                                    ...
                                    <div class="x_content">
                                        ...
                                        <form action="../../actualizarVoto.do" method="get">

                                            <input type="hidden" name="idvoto" value="<%=request.getParameter("idVoto")%>"> Nombre
                                            Cliente<input type="text" name="cliente" value="<%=request.getParameter("cliente")%>"/></br>
                                            Multimedia<input type="text" name="multimedia" value="<%=request.getParameter("multimedia")%>"/></br>
                                            Puntos<input type="text" name="puntos" value="<%=request.getParameter("puntos")%>"/></br>

                                            <input type="submit" value="Enviar" />
                                            
                                        </form>
                                        <form action="../../mostrarVoto.do">
